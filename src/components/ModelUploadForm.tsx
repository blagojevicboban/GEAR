...
const ModelUploadForm: React.FC<ModelUploadFormProps> = ({
    ...
    const [formData, setFormData] = useState({
        ...
        sector:
            sectors.length > 0
                ? sectors[0]
                : (EDUSector.MECHATRONICS as string),
        customSector: '',
        equipmentType: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const finalSector = showCustomSector
                ...
                : formData.sector;
            const tips = await generateOptimizationSuggestions(
                formData.modelFile.size,
                finalSector
            );
            ...
            const newModel: VETModel = {
                ...
                thumbnailUrl:
                    thumbnailPreview ||
                    `https://picsum.photos/seed/${formData.name}/600/400`,
                optimized: true,
                    ...
                    <div className="py-12 text-center">
                        <div className="mb-8 flex flex-col items-center">
                            ...
                            <p className="text-slate-400 text-sm max-w-sm mx-auto">
                                Validating file integrity and generating
                                metadata.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="border-2 border-dashed border-slate-700 rounded-2xl p-6 text-center hover:border-indigo-500/50 transition-all cursor-pointer bg-slate-950/50 group h-40 flex flex-col items-center justify-center">
                                    ...
                                    >
                                        <svg
                                            className={`w-8 h-8 mb-2 transition-colors ${formData.modelFile ? 'text-green-500' : 'text-slate-600 group-hover:text-indigo-400'}`}
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border-2 border-dashed border-slate-700 rounded-2xl p-2 text-center hover:border-indigo-500/50 transition-all cursor-pointer bg-slate-950/50 group h-40 flex items-center justify-center relative overflow-hidden">
                                    ...
                                    <label
                                        ...
                                        className="cursor-pointer z-10 w-full h-full flex flex-col items-center justify-center"
                                    >
                                        <svg
                                            className="w-8 h-8 mb-2 text-slate-600 group-hover:text-indigo-400"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
