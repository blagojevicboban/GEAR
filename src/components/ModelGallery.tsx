...
const ModelGallery: React.FC<ModelGalleryProps> = ({
    ...
    const uniqueUploaders = Array.from(
        new Set(models.map((m) => m.uploadedBy))
    ).sort();
                    ...
                    >
                        ...
                        <div className="p-5 flex-1 flex flex-col">
                            <div className="flex justify-between items-start mb-2">
                                ...
                                >
                                    {model.modelUrl
                                        ...
                                        ?.toUpperCase() || 'CAD'}{' '}
                                    •{' '}
                                    {(model.fileSize / 1024 / 1024).toFixed(1)}
                                    MB
                                </span>
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-1">
                                ...
                                {model.optimized && (
                                    <div
                                        className="flex items-center gap-1 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-400 px-2 py-0.5 rounded-full border border-emerald-500/30"
                                        title="Optimized by AI CAD Engine"
                                    >
                                        <Sparkles size={10} />
                                        <span className="text-[10px] font-bold uppercase">
                                            {t('gallery.ai_optimized')}
                                        </span>
                                    </div>
                                )}
                            </div>
