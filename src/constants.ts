...
export const INITIAL_MODELS: VETModel[] = [
    ...
    },
    {
        ...
        level: EquipmentLevel.ADVANCED,
        modelUrl:
            'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/FlightHelmet/glTF-Binary/FlightHelmet.glb', // Placeholder for actual robot model
