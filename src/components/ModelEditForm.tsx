...
const ModelEditForm: React.FC<ModelEditFormProps> = ({
    ...
    const handleHotspotChange = (
        id: string,
        field: keyof Hotspot | 'pos_x' | 'pos_y' | 'pos_z',
        value: any
    ) => {
        setHotspots(
            hotspots.map((h) => {
                ...
                if (field === 'pos_x')
                    return {
                        ...h,
                        position: { ...h.position, x: parseFloat(value) || 0 },
                    };
                if (field === 'pos_y')
                    return {
                        ...h,
                        position: { ...h.position, y: parseFloat(value) || 0 },
                    };
                if (field === 'pos_z')
                    return {
                        ...h,
                        position: { ...h.position, z: parseFloat(value) || 0 },
                    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const finalSector = showCustomSector
        ...
        if (formData.modelFile) {
            ...
            try {
                ...
                alert(
                    'Failed to upload new model file. Metadata will still be updated.'
                );
        ...
        if (formData.thumbnailFile) {
            ...
            try {
                ...
                alert(
                    'Failed to upload thumbnail image. It will remain unchanged.'
                );
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
                ...
                <p className="text-slate-400 mb-8 text-sm">
                    Update technical details and pedagogical markers for{' '}
                    {model.name}.
                </p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div className="flex-1 space-y-4">
                                    ...
                                    <p className="text-[10px] text-slate-500 italic uppercase tracking-tighter">
                                        Recommended 1200x675px resolution.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setFormData({
                                                ...formData,
                                                level: e.target
                                                    .value as EquipmentLevel,
                                            })
                                        }
                                    >
                                        {Object.values(EquipmentLevel).map(
                                            (l) => (
                            ...
                            <div className="border-2 border-dashed border-slate-700 rounded-2xl p-6 text-center hover:border-indigo-500/50 transition-colors cursor-pointer bg-slate-950/50">
                                ...
                                >
                                    ...
                                    <p className="text-xs text-slate-500 mt-1 italic">
                                        Optional replacement of .glb, .gltf,
                                        .pdb, .stp, .step or .stl binary.
                                    </p>
                                </label>
                            </div>
                        </div>
