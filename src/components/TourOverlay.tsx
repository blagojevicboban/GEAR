            ...
            <div
                ...
                style={{
                    ...
                    WebkitMaskImage: targetRect
                        ? `radial-gradient(circle at ${targetRect.left + targetRect.width / 2}px ${targetRect.top + targetRect.height / 2}px, transparent ${Math.max(targetRect.width, targetRect.height) / 2}px, black ${Math.max(targetRect.width, targetRect.height) / 2 + 20}px)`
                        : 'none',
                }}
            />
