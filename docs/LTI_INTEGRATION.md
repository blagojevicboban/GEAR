...
4.  **Services**:
    *   IMS LTI Assignment and Grade Services: *Use this service for grade sync and column management* (Future support).
...
*Currently, new platforms must be registered via the database or a custom admin script. In production, this process will be automated via dynamic registration.*
